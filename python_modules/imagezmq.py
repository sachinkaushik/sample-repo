...
class ImageSender():
    ...
    def send_image_reqrep(self, msg, image, data = {}):
        ...
        if image.flags['C_CONTIGUOUS']:
            ...
            self.zmq_socket.send_array(image, data, msg, copy=False)
        else:
    ...
    def send_image_pubsub(self, msg, image, data = {}):
...
class ImageHub():
    ...
    def recv_image(self, copy=False):
        ...
        msg, image, data = self.zmq_socket.recv_array(copy=False)
        return msg, image, data
...
class SerializingSocket(zmq.Socket):
    ...
    def send_array(self, A, data, msg='NoName',flags=0, copy=True, track=False):
    ...
    def recv_array(self, flags=0, copy=True, track=False):
        ...
        return (md['msg'], A.reshape(md['shape']), md['data'])
