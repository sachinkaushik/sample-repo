...
docker build --platform linux/x86_64 -f roc-models/sca-0.1.x/out/roc-adapter-stubs-sca-0.1.x/Dockerfile -t default-route-openshift-image-registry.apps.nex.one-edge.intel.com/springboard-dev-common/roc-adapter-sca-0.1.x:0.1.0-dev roc-models/sca-0.1.x/out/roc-adapter-stubs-sca-0.1.x&
