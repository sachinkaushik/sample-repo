...
module tmp/out/roc-adapter-stubs-sca-0.1.x

go 1.18

require (
	github.com/intel-innersource/frameworks.edge.one-intel-edge.maestro-app.roc.config-adapter v0.0.5
...
require (
	...
	github.com/onosproject/onos-api/go v0.9.46 // indirect
