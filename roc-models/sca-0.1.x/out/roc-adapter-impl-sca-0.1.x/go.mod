...
module github.com/intel-innersource/frameworks.edge.one-intel-edge.springboard.reference-implementation.roc-adapters.sca

go 1.18

require (
	github.com/intel-innersource/frameworks.edge.one-intel-edge.maestro-app.roc.config-adapter v0.0.7
	github.com/intel-innersource/frameworks.edge.one-intel-edge.springboard.reference-implementation.roc-models/models/sca-0.1.x v0.1.0
...
require (
	...
	github.com/google/gnxi v0.0.0-20210716134716-cb5c55758a07 // indirect
