...
import (
	...
	"github.com/intel-innersource/frameworks.edge.one-intel-edge.springboard.reference-implementation.roc-adapters.sca/pkg/custom"
...
func getModels() *gnmi.Model {
	model := gnmi.NewModel(models.ModelData(),
		...
		models.Unmarshal,
		//models.ΛEnum  // NOTE: There is no Enum in the SCA models? So use a blank map.
