...
docker build --platform linux/x86_64 -f roc-models/sra-0.2.x/out/roc-adapter-stubs-sra-0.2.x/Dockerfile -t default-route-openshift-image-registry.apps.nex.one-edge.intel.com/springboard-dev-common/roc-adapter-sra-0.2.x:v0.0.1 roc-models/sra-0.2.x/out/roc-adapter-stubs-sra-0.2.x&
